...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0C0C0C] px-5 sm:px-8 md:px-10 py-20"
    >
      <FadeIn
        delay={0.1}
        x={-80}
      ...
      >
        <img
          src={`${IMAGE_BASE}/moon_icon.11395d36.png`}
          alt=""
          aria-hidden="true"
      ...
      >
        <img
          src={`${IMAGE_BASE}/p59_1.4659672e.png`}
          alt=""
          aria-hidden="true"
      ...
      >
        <img
          src={`${IMAGE_BASE}/lego_icon-1.703bb594.png`}
          alt=""
          aria-hidden="true"
          className="w-[120px] sm:w-[160px] md:w-[210px]"
        />
      ...
      >
        <img
          src={`${IMAGE_BASE}/Group_134-1.2e04f3ce.png`}
          alt=""
          aria-hidden="true"
